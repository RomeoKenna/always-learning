package com.yfk.spring.aop.demo11;

import com.yfk.spring.aop.demo11.test1.CarService;
import com.yfk.spring.aop.demo11.test1.MainConfig1;
import com.yfk.spring.aop.demo11.test1.UserService;
import com.yfk.spring.aop.demo11.test2.MainConfig2;
import com.yfk.spring.aop.demo11.test2.Service2;
import com.yfk.spring.aop.demo11.test3.MoreAdvice;
import com.yfk.spring.aop.demo11.test4.MainConfig4;
import com.yfk.spring.aop.demo11.test4.Service4;
...
public class AspectTest11 {
    ...
    public void test2() {
        ...
        System.out.println(service2.say("yfk"));
    }
    ...
    public void test3() {
        ...
        //通过代理对象访问目标方法say
        System.out.println(proxy.say("yfk"));
    }
    ...
    public void test4() {
        ...
        System.out.println(service4.say("yfk"));
    }
